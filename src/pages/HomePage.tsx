...
export function HomePage() {
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative z-10 flex w-full max-w-4xl flex-col items-center gap-12 px-6 py-24 text-center">
        <GameLogo />
        ...
        <div className="mt-4 flex flex-col items-center gap-4 sm:flex-row sm:gap-5">
          ...
          <CyberButton variant="secondary">How to Play</CyberButton>
